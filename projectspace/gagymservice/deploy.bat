...
ssh -i "/Users/hee/Documents/keys/gagymservice.pem" ubuntu@ec2-52-79-120-222.ap-northeast-2.compute.amazonaws.com "cd /home/ubuntu/web/gagymservice; ./run.sh gagymservice"
